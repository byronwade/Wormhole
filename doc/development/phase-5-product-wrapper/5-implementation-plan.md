1) Scaffold Tauri app: npm create tauri-app@latest -> apps/teleport-ui (React/TS/Vite/Tailwind), id com.wormhole.app.
2) Update root Cargo workspace members to include apps/teleport-ui/src-tauri.
...
5) apps/teleport-ui/src-tauri/Cargo.toml: depend on teleport_daemon (path), tokio, tauri.
