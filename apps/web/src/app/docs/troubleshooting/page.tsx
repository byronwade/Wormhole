  ...
  return (
    <div className="space-y-12">
      ...
      <section className="space-y-6">
        <h2 className="text-2xl font-bold text-foreground">Start Here: Run Doctor</h2>
        <p className="text-muted-foreground">
          The <code className="bg-muted px-1.5 py-0.5 rounded text-wormhole-hunter-light">wormhole doctor</code> command automatically checks your system for common issues:
        </p>
          ...
          <Card className="bg-card/50 border-border">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <h4 className="font-medium text-foreground">&quot;FUSE not found&quot; or &quot;fuse: failed to open /dev/fuse&quot;</h4>
                <p className="text-sm text-muted-foreground">FUSE is not installed or not properly configured.</p>
                <Card className="bg-card border-border">
                  <CardContent className="p-0">
...
sudo dnf install fuse3 fuse3-devel`}
              ...
              <div className="space-y-2">
                <h4 className="font-medium text-foreground">&quot;Mount point is busy&quot; or &quot;Device or resource busy&quot;</h4>
                <p className="text-sm text-muted-foreground">Previous mount wasn&apos;t cleaned up properly.</p>
                <Card className="bg-card border-border">
                  <CardContent className="p-0">
                    <pre className="p-3 text-xs overflow-x-auto">
                      <code className="text-muted-foreground">
...
sudo umount -l ~/mnt/wormhole`}
              ...
              <div className="space-y-2">
                <h4 className="font-medium text-foreground">macOS: &quot;System Extension Blocked&quot;</h4>
                <p className="text-sm text-muted-foreground">macFUSE kernel extension needs approval.</p>
          ...
          <Card className="bg-card/50 border-border">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <h4 className="font-medium text-foreground">&quot;Failed to connect to signal server&quot;</h4>
                <p className="text-sm text-muted-foreground">Can&apos;t reach the signal server for peer discovery.</p>
                <Card className="bg-card border-border">
                  <CardContent className="p-0">
                    <pre className="p-3 text-xs overflow-x-auto">
                      <code className="text-muted-foreground">
...
wormhole mount 192.168.1.42:4433 ~/mnt`}
              ...
              <div className="space-y-2">
                <h4 className="font-medium text-foreground">&quot;Connection timed out&quot; or &quot;Peer not found&quot;</h4>
                <p className="text-sm text-muted-foreground">Can&apos;t establish connection with the host.</p>
...
sudo iptables -L -n | grep 4433`}
              ...
              <div className="space-y-2">
                <h4 className="font-medium text-foreground">&quot;NAT traversal failed&quot;</h4>
                <p className="text-sm text-muted-foreground">STUN/TURN couldn&apos;t establish a direct connection.</p>
                <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
          ...
          <Card className="bg-card/50 border-border">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <h4 className="font-medium text-foreground">Slow file access / high latency</h4>
                <p className="text-sm text-muted-foreground">Files taking too long to open or read.</p>
                <Card className="bg-card border-border">
                  <CardContent className="p-0">
                    <pre className="p-3 text-xs overflow-x-auto">
                      <code className="text-muted-foreground">
...
wormhole ping CODE`}
              ...
              <div className="space-y-2">
                <h4 className="font-medium text-foreground">Low throughput</h4>
                <p className="text-sm text-muted-foreground">Not getting expected transfer speeds.</p>
                <Card className="bg-card border-border">
                  <CardContent className="p-0">
                    <pre className="p-3 text-xs overflow-x-auto">
                      <code className="text-muted-foreground">
...
wormhole mount CODE ~/mnt \\
    ...
    --prefetch`}
              ...
              <div className="space-y-2">
                <h4 className="font-medium text-foreground">High CPU usage</h4>
                <p className="text-sm text-muted-foreground">Wormhole using too much CPU.</p>
                <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
      ...
      {/* Debug Mode */}
      <section className="space-y-6">
        <h2 className="text-2xl font-bold text-foreground">Debug Mode</h2>
        <p className="text-muted-foreground">
...
tail -f ~/.cache/wormhole/wormhole.log`}
      ...
      {/* Error Codes */}
      <section className="space-y-6">
        <h2 className="text-2xl font-bold text-foreground">Common Error Codes</h2>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-border">
                    ...
                    <th className="text-left py-2 text-muted-foreground font-medium">Solution</th>
                  </tr>
                </thead>
      ...
      {/* Reset / Clean Slate */}
      <section className="space-y-6">
        <h2 className="text-2xl font-bold text-foreground">Reset to Clean Slate</h2>
        <p className="text-muted-foreground">
...
brew reinstall wormhole  # or your install method`}
      ...
      {/* Getting Help */}
      <section className="space-y-6">
        <h2 className="text-2xl font-bold text-foreground">Getting More Help</h2>
          ...
          <Link href="/docs/troubleshooting/fuse">
            <Card className="bg-card/50 border-border hover:border-wormhole-hunter/50 transition-colors h-full">
              <CardContent className="p-6">
                ...
                <h3 className="font-semibold text-foreground mb-1">FUSE Troubleshooting</h3>
                <p className="text-sm text-muted-foreground">Platform-specific FUSE issues and solutions</p>
              </CardContent>
            </Card>
          </Link>
          <Link href="/docs/troubleshooting/network">
            <Card className="bg-card/50 border-border hover:border-wormhole-hunter/50 transition-colors h-full">
              <CardContent className="p-6">
                ...
                <h3 className="font-semibold text-foreground mb-1">Network Troubleshooting</h3>
                <p className="text-sm text-muted-foreground">NAT, firewalls, and connectivity issues</p>
              </CardContent>
            </Card>
          </Link>
          <Link href="/docs/troubleshooting/performance">
            <Card className="bg-card/50 border-border hover:border-wormhole-hunter/50 transition-colors h-full">
              <CardContent className="p-6">
                ...
                <h3 className="font-semibold text-foreground mb-1">Performance Issues</h3>
                <p className="text-sm text-muted-foreground">Diagnose and fix slow transfers</p>
              </CardContent>
            </Card>
          </Link>
